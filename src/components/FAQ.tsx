const col1 = [
  { q: "Does TikTak Cover My Area?", a: "Yes! There are couriers using TikTak all over the country and abroad, so whether you need to move a sofa across town or send a car across Europe, we have got you covered." },
  ...
  { q: "Does TikTak Provide Packing Materials?", a: "If your item requires packing materials or extra care then you should make sure this is highlighted in your listing and discussed with any transport provider whose quote you are considering. Couriers on TikTak are able to provide all levels of service and can help pack your items, just ensure you inform them of your needs." },
  { q: "Can I Travel With My Goods?", a: "The majority of transport providers on TikTak are only insured for the transportation of goods, however, some are also able to take people. If you need to travel with your goods, make sure to mention this in your listing and to highlight this to any courier who quotes on your listing." },
  { q: "Does TikTak Have Different Sized Vehicles?", a: "There are thousands of couriers on TikTak, with a wide range of vehicle sizes capable of handling any delivery. Providing the rough dimensions (and pictures if possible) on your listing will allow the delivery company to get the right vehicle sent out to you." },
...
const col2 = [
  ...
  { q: "How Can I Contact TikTak Support?", a: "TikTak Support is available from 9am - 6pm Monday to Friday. You can send an email to our support team." },
  ...
  { q: "Can Items Be Taken Upstairs?", a: "Yes, items can be taken upstairs if needed, and can also be assembled. Transport providers on TikTak are happy to provide these services, but you should mention these requirements in your listing." },
