...
export default function Hero() {
  return (
    <section className="relative bg-gradient-to-r from-heroFrom to-heroTo pt-12 pb-16 rounded-bl-[100px]">
      <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <div className="mt-6 bg-white rounded-2xl shadow-lg p-5 space-y-4">
            ...
            <Link
              to="/ride"
              className="block w-full text-center bg-cta hover:bg-ctaHover text-white font-semibold py-3 rounded-lg transition"
            >
