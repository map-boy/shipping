    ...
    <section className="relative mt-20">
      <div className="max-w-7xl mx-auto bg-gradient-to-b from-slate-100 rounded-tl-[100px] px-4 sm:px-6 pt-12 md:pt-20 pb-12">
        <h2 className="text-2xl font-bold text-gray-900 mb-4 md:mb-8 text-center md:text-left">
          More about YourBrand
        </h2>
        <div className="flex flex-col md:flex-row items-center gap-8">
          <div className="w-full md:w-2/3">
            <p className="text-lg text-slate-500 text-justify">
              YourBrand makes it simple to get delivery quotes: fill out one short form
              ...
              awkward items, YourBrand connects you with experienced movers for both
              local and international delivery.
            </p>
          </div>
          <div className="w-full md:w-1/3">
            <img src={aboutImg} alt="More about YourBrand" className="w-full h-auto rounded-xl" />
          </div>
        </div>
      </div>
    </section>
