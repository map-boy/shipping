...
const services = [
  "Furniture Delivery", "Motorbike Transport", "Car Transport", "Man And Van",
  "eBay Deliveries", "Fragile Item Transport", "Boat Transport", "Removals",
];
        ...
        <div className="flex justify-center">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {services.map((service, i) => (
              <a key={service} href="#" className={`relative bg-gray-200 border border-gray-300 rounded-md overflow-hidden group h-[200px] w-[135px] sm:h-[298px] sm:w-[198px] ${i % 2 === 1 ? "mt-10 sm:mt-20" : ""}`}>
